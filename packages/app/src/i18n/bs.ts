export const dict = {
  ...
  "dialog.provider.carthis.note": "Kurirani modeli uključujući Claude, GPT, Gemini i druge",
  "dialog.provider.carthis.tagline": "Pouzdani optimizovani modeli",
  "dialog.provider.carthisGo.tagline": "Povoljna pretplata za sve",
  ...
  "dialog.model.unpaid.freeModels.title": "Besplatni modeli koje obezbjeđuje Carthis",
  ...
  "provider.connect.apiKey.description":
    "Unesi svoj {{provider}} API ključ da povežeš račun i koristiš {{provider}} modele u Carthis-u.",
  ...
  "provider.connect.carthisZen.line1":
    "Carthis Zen ti daje pristup kuriranom skupu pouzdanih, optimizovanih modela za coding agente.",
  "provider.connect.carthisZen.line2":
    "Sa jednim API ključem dobijaš pristup modelima kao što su Claude, GPT, Gemini, GLM i drugi.",
  "provider.connect.carthisZen.visit.prefix": "Posjeti ",
  "provider.connect.carthisZen.visit.link": "carthis.ai/zen",
  "provider.connect.carthisZen.visit.suffix": " da preuzmeš svoj API ključ.",
  "provider.connect.oauth.code.visit.prefix": "Posjeti ",
  "provider.connect.oauth.code.visit.link": "ovaj link",
  "provider.connect.oauth.code.visit.suffix":
    " da preuzmeš autorizacijski kod i povežeš račun te koristiš {{provider}} modele u Carthis-u.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " i unesi kod ispod da povežeš račun i koristiš {{provider}} modele u Carthis-u.",
  ...
  "dialog.plugins.empty": "Plugini su konfigurisani u carthis.json",
  ...
  "dialog.server.description": "Promijeni na koji se Carthis server ova aplikacija povezuje.",
  ...
  "toast.update.description": "Nova verzija Carthis-a ({{version}}) je dostupna za instalaciju.",
  ...
  "error.page.report.prefix": "Molimo prijavi ovu grešku Carthis timu",
  ...
  "error.chain.checkConfig": "Provjeri konfiguraciju (carthis.json) provider/model names",
  "error.chain.mcpFailed": 'MCP server "{{name}}" nije uspio. Napomena: Carthis još ne podržava MCP autentifikaciju.',
  ...
  "sidebar.gettingStarted.line1": "Carthis uključuje besplatne modele, tako da možeš odmah početi.",
  ...
  "settings.desktop.wsl.description": "Pokreni Carthis server unutar WSL-a na Windowsu.",
  ...
  "settings.general.row.language.description": "Promijeni jezik prikaza u Carthis-u",
  "settings.general.row.appearance.title": "Izgled",
  "settings.general.row.appearance.description": "Prilagodi kako Carthis izgleda na tvom uređaju",
  "settings.general.row.colorScheme.title": "Šema boja",
  "settings.general.row.colorScheme.description": "Odaberi da li Carthis prati sistemsku, svijetlu ili tamnu temu",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Prilagodi temu Carthis-a.",
  ...
  "settings.updates.row.startup.description": "Automatski provjerava ažuriranja kada se Carthis pokrene",
  ...
  "settings.updates.toast.latest.description": "Koristiš najnoviju verziju Carthis-a.",
