export const dict = {
  ...
  "dialog.provider.carthis.note": "Udvalgte modeller inklusive Claude, GPT, Gemini og flere",
  "dialog.provider.carthis.tagline": "Pålidelige optimerede modeller",
  "dialog.provider.carthisGo.tagline": "Billigt abonnement for alle",
  ...
  "dialog.model.unpaid.freeModels.title": "Gratis modeller leveret af Carthis",
  ...
  "provider.connect.apiKey.description":
    "Indtast din {{provider}} API-nøgle for at forbinde din konto og bruge {{provider}} modeller i Carthis.",
  ...
  "provider.connect.carthisZen.line1":
    "Carthis Zen giver dig adgang til et udvalg af pålidelige optimerede modeller til kodningsagenter.",
  "provider.connect.carthisZen.line2":
    "Med en enkelt API-nøgle får du adgang til modeller som Claude, GPT, Gemini, GLM og flere.",
  "provider.connect.carthisZen.visit.prefix": "Besøg ",
  "provider.connect.carthisZen.visit.link": "carthis.ai/zen",
  "provider.connect.carthisZen.visit.suffix": " for at hente din API-nøgle.",
  "provider.connect.oauth.code.visit.prefix": "Besøg ",
  "provider.connect.oauth.code.visit.link": "dette link",
  "provider.connect.oauth.code.visit.suffix":
    " for at hente din godkendelseskode for at forbinde din konto og bruge {{provider}} modeller i Carthis.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " og indtast koden nedenfor for at forbinde din konto og bruge {{provider}} modeller i Carthis.",
  ...
  "dialog.plugins.empty": "Plugins konfigureret i carthis.json",
  ...
  "dialog.server.description": "Skift hvilken Carthis-server denne app forbinder til.",
  ...
  "toast.update.description": "En ny version af Carthis ({{version}}) er nu tilgængelig til installation.",
  ...
  "error.page.report.prefix": "Rapporter venligst denne fejl til Carthis-teamet",
  ...
  "error.chain.checkConfig": "Tjek dine konfigurations (carthis.json) udbyder/modelnavne",
  "error.chain.mcpFailed": 'MCP-server "{{name}}" fejlede. Bemærk, Carthis understøtter ikke MCP-godkendelse endnu.',
  ...
  "sidebar.gettingStarted.line1": "Carthis inkluderer gratis modeller så du kan starte med det samme.",
  ...
  "settings.desktop.wsl.description": "Kør Carthis-serveren inde i WSL på Windows.",
  ...
  "settings.general.row.language.description": "Ændr visningssproget for Carthis",
  "settings.general.row.appearance.title": "Udseende",
  "settings.general.row.appearance.description": "Tilpas hvordan Carthis ser ud på din enhed",
  "settings.general.row.colorScheme.title": "Farveskema",
  "settings.general.row.colorScheme.description": "Vælg om Carthis følger systemets, lyst eller mørkt tema",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Tilpas hvordan Carthis er temabestemt.",
  ...
  "settings.updates.row.startup.description": "Tjek automatisk for opdateringer, når Carthis starter",
  ...
  "settings.updates.toast.latest.description": "Du kører den nyeste version af Carthis.",
