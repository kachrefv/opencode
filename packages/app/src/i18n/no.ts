...
export const dict = {
  ...
  "dialog.provider.carthis.note": "Utvalgte modeller inkludert Claude, GPT, Gemini og mer",
  "dialog.provider.carthis.tagline": "Pålitelige, optimaliserte modeller",
  "dialog.provider.carthisGo.tagline": "Rimelig abonnement for alle",
  ...
  "dialog.model.unpaid.freeModels.title": "Gratis modeller levert av Carthis",
  ...
  "provider.connect.apiKey.description":
    "Skriv inn din {{provider}} API-nøkkel for å koble til kontoen din og bruke {{provider}}-modeller i Carthis.",
  ...
  "provider.connect.carthisZen.line1":
    "Carthis Zen gir deg tilgang til et utvalg av pålitelige optimaliserte modeller for kodeagenter.",
  "provider.connect.carthisZen.line2":
    "Med én enkelt API-nøkkel får du tilgang til modeller som Claude, GPT, Gemini, GLM og flere.",
  "provider.connect.carthisZen.visit.prefix": "Besøk ",
  "provider.connect.carthisZen.visit.link": "carthis.ai/zen",
  "provider.connect.carthisZen.visit.suffix": " for å hente API-nøkkelen din.",
  "provider.connect.oauth.code.visit.prefix": "Besøk ",
  "provider.connect.oauth.code.visit.link": "denne lenken",
  "provider.connect.oauth.code.visit.suffix":
    " for å hente autorisasjonskoden din for å koble til kontoen din og bruke {{provider}}-modeller i Carthis.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " og skriv inn koden nedenfor for å koble til kontoen din og bruke {{provider}}-modeller i Carthis.",
  ...
  "dialog.plugins.empty": "Plugins konfigurert i carthis.json",
  ...
  "dialog.server.description": "Bytt hvilken Carthis-server denne appen kobler til.",
  ...
  "toast.update.description": "En ny versjon av Carthis ({{version}}) er nå tilgjengelig for installasjon.",
  ...
  "error.page.report.prefix": "Vennligst rapporter denne feilen til Carthis-teamet",
  ...
  "error.chain.checkConfig": "Sjekk leverandør-/modellnavnene i konfigurasjonen din (carthis.json)",
  "error.chain.mcpFailed": 'MCP-server "{{name}}" mislyktes. Merk at Carthis ikke støtter MCP-autentisering ennå.',
  ...
  "sidebar.gettingStarted.line1": "Carthis inkluderer gratis modeller så du kan starte umiddelbart.",
  ...
  "settings.desktop.wsl.description": "Kjør Carthis-serveren i WSL på Windows.",
  ...
  "settings.general.row.language.description": "Endre visningsspråket for Carthis",
  "settings.general.row.appearance.title": "Utseende",
  "settings.general.row.appearance.description": "Tilpass hvordan Carthis ser ut på enheten din",
  "settings.general.row.colorScheme.title": "Fargevalg",
  "settings.general.row.colorScheme.description": "Velg om Carthis skal følge systemets, lyst eller mørkt tema",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Tilpass hvordan Carthis er tematisert.",
  ...
  "settings.updates.row.startup.description": "Se automatisk etter oppdateringer når Carthis starter",
  ...
  "settings.updates.toast.latest.description": "Du bruker den nyeste versjonen av Carthis.",
