export const dict = {
  ...
  "dialog.provider.carthis.note": "Wyselekcjonowane modele, w tym Claude, GPT, Gemini i inne",
  "dialog.provider.carthis.tagline": "Niezawodne, zoptymalizowane modele",
  "dialog.provider.carthisGo.tagline": "Tania subskrypcja dla każdego",
  ...
  "dialog.model.unpaid.freeModels.title": "Darmowe modele dostarczane przez Carthis",
  ...
  "provider.connect.apiKey.description":
    "Wprowadź swój klucz API {{provider}}, aby połączyć konto i używać modeli {{provider}} w Carthis.",
  ...
  "provider.connect.carthisZen.line1":
    "Carthis Zen daje dostęp do wybranego zestawu niezawodnych, zoptymalizowanych modeli dla agentów kodujących.",
  ...
  "provider.connect.carthisZen.visit.prefix": "Odwiedź ",
  "provider.connect.carthisZen.visit.link": "carthis.ai/zen",
  "provider.connect.carthisZen.visit.suffix": ", aby odebrać swój klucz API.",
  "provider.connect.oauth.code.visit.prefix": "Odwiedź ",
  "provider.connect.oauth.code.visit.link": "ten link",
  "provider.connect.oauth.code.visit.suffix":
    ", aby odebrać kod autoryzacyjny, połączyć konto i używać modeli {{provider}} w Carthis.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " i wprowadź poniższy kod, aby połączyć konto i używać modeli {{provider}} w Carthis.",
  ...
  "dialog.plugins.empty": "Wtyczki skonfigurowane w carthis.json",
  ...
  "dialog.server.description": "Przełącz serwer Carthis, z którym łączy się ta aplikacja.",
  ...
  "toast.update.description": "Nowa wersja Carthis ({{version}}) jest teraz dostępna do instalacji.",
  ...
  "error.page.report.prefix": "Proszę zgłosić ten błąd do zespołu Carthis",
  ...
  "error.chain.checkConfig": "Sprawdź swoją konfigurację (carthis.json) nazwy dostawców/modeli",
  ...
  "sidebar.gettingStarted.line1": "Carthis zawiera darmowe modele, więc możesz zacząć od razu.",
  ...
  "settings.general.row.language.description": "Zmień język wyświetlania dla Carthis",
  "settings.general.row.appearance.title": "Wygląd",
  "settings.general.row.appearance.description": "Dostosuj wygląd Carthis na swoim urządzeniu",
  "settings.general.row.colorScheme.title": "Schemat kolorów",
  "settings.general.row.colorScheme.description":
    "Wybierz, czy Carthis ma używać motywu systemowego, jasnego czy ciemnego",
  "settings.general.row.theme.title": "Motyw",
  "settings.general.row.theme.description": "Dostosuj motyw Carthis.",
  ...
  "settings.updates.row.startup.description": "Automatycznie sprawdzaj aktualizacje podczas uruchamiania Carthis",
  ...
  "settings.updates.toast.latest.description": "Korzystasz z najnowszej wersji Carthis.",
