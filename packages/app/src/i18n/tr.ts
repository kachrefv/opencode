...
export const dict = {
  ...
  "dialog.provider.carthis.note": "Claude, GPT, Gemini ve daha fazlasını içeren seçilmiş modeller",
  "dialog.provider.carthis.tagline": "Güvenilir optimize edilmiş modeller",
  "dialog.provider.carthisGo.tagline": "Herkes için düşük maliyetli abonelik",
  ...
  "dialog.model.unpaid.freeModels.title": "Carthis tarafından sunulan ücretsiz modeller",
  ...
  "provider.connect.apiKey.description":
    "{{provider}} hesabınızı bağlamak ve Carthis'da {{provider}} modellerini kullanmak için {{provider}} API anahtarınızı girin.",
  ...
  "provider.connect.carthisZen.line1":
    "Carthis Zen, kodlama ajanları için seçilmiş güvenilir optimize edilmiş modellere erişim sağlar.",
  ...
  "provider.connect.carthisZen.visit.prefix": "",
  "provider.connect.carthisZen.visit.link": "carthis.ai/zen",
  "provider.connect.carthisZen.visit.suffix": " adresini ziyaret ederek API anahtarınızı alın.",
  "provider.connect.oauth.code.visit.prefix":
    "Hesabınızı bağlamak ve Carthis'da {{provider}} modellerini kullanmak için ",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " tıklayarak aşağıdaki kodu girin ve hesabınızı bağlayarak Carthis'da {{provider}} modellerini kullanın.",
  ...
  "dialog.plugins.empty": "Eklentiler carthis.json içinde yapılandırılır",
  ...
  "dialog.server.description": "Bu uygulamanın hangi Carthis sunucusuna bağlanacağını değiştirin.",
  ...
  "toast.update.description": "Carthis'un yeni bir sürümü ({{version}}) yüklemeye hazır.",
  ...
  "error.page.report.prefix": "Lütfen bu hatayı Carthis ekibine bildirin",
  ...
  "error.chain.checkConfig": "Yapılandırma dosyanızı (carthis.json) sağlayıcı/model adlarını kontrol edin",
  "error.chain.mcpFailed":
    'MCP sunucusu "{{name}}" başarısız oldu. Not: Carthis henüz MCP kimlik doğrulamasını desteklemiyor.',
  ...
  "sidebar.gettingStarted.line1": "Carthis ücretsiz modeller içerir, böylece hemen başlayabilirsiniz.",
  ...
  "app.name.desktop": "Carthis Masaüstü",
  ...
  "settings.desktop.wsl.description": "Carthis sunucusunu Windows'ta WSL içinde çalıştırın.",
  ...
  "settings.general.row.language.description": "Carthis'un görünüm dilini değiştirin",
  "settings.general.row.appearance.title": "Görünüm",
  "settings.general.row.appearance.description": "Carthis'un cihazınızdaki görünümünü özelleştirin",
  "settings.general.row.colorScheme.title": "Renk şeması",
  "settings.general.row.colorScheme.description":
    "Carthis'un sistem, açık veya koyu temayı takip etip etmeyeceğini seçin",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Carthis'un temasını özelleştirin.",
  ...
  "settings.updates.row.startup.description": "Carthis başladığında otomatik güncelleme kontrolü yap",
  ...
  "settings.updates.toast.latest.description": "Carthis'un en son sürümünü kullanıyorsunuz.",
