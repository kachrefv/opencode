export const dict = {
  ...
  "desktop.updater.none.message": "Ya estás usando la versión más reciente de Carthis",
  ...
  "desktop.updater.downloaded.prompt":
    "Se ha descargado la versión {{version}} de Carthis. ¿Quieres instalarla y reiniciar?",
