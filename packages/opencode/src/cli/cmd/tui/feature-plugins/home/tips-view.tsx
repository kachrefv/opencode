...
const TIPS = [
  ...
  "Run {highlight}/share{/highlight} to create a public link to your conversation at carthis.ai",
  ...
  "Create {highlight}carthis.json{/highlight} for server settings and {highlight}tui.json{/highlight} for TUI settings",
  ...
  "Carthis auto-handles OAuth for remote MCP servers requiring auth",
  ...
  "Carthis auto-formats files using prettier, gofmt, ruff, and more",
  'Set {highlight}"formatter": false{/highlight} in config to disable all auto-formatting',
  "Define custom formatter commands with file extensions in config",
  "Carthis uses LSP servers for intelligent code analysis",
  ...
  "Create a plugin to prevent Carthis from reading sensitive files",
  "Use {highlight}carthis run{/highlight} for non-interactive scripting",
  "Use {highlight}carthis --continue{/highlight} to resume the last session",
  "Use {highlight}carthis run -f file.ts{/highlight} to attach files via CLI",
  "Use {highlight}--format json{/highlight} for machine-readable output in scripts",
  "Run {highlight}carthis serve{/highlight} for headless API access to Carthis",
  "Use {highlight}carthis run --attach{/highlight} to connect to a running server",
  "Run {highlight}carthis upgrade{/highlight} to update to the latest version",
  "Run {highlight}carthis auth list{/highlight} to see all configured providers",
  "Run {highlight}carthis agent create{/highlight} for guided agent creation",
  "Use {highlight}/carthis{/highlight} in GitHub issues/PRs to trigger AI actions",
  "Run {highlight}carthis github install{/highlight} to set up the GitHub workflow",
  "Comment {highlight}/carthis fix this{/highlight} on issues to auto-create PRs",
  ...
  "Run {highlight}carthis debug config{/highlight} to troubleshoot configuration",
  ...
  "Use {highlight}/connect{/highlight} with Carthis Zen for curated, tested models",
