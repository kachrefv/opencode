...
export const Flag = {
  ...
  OPENCODE_EXPERIMENTAL_INDEXER: Config.boolean("OPENCODE_EXPERIMENTAL_INDEXER").pipe(
    Config.withDefault(false),
  ),
  OPENCODE_EXPERIMENTAL_DISABLE_INDEXER: Config.boolean("OPENCODE_EXPERIMENTAL_DISABLE_INDEXER").pipe(
    Config.withDefault(false),
  ),
